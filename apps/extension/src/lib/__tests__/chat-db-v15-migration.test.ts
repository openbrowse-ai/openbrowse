...
async function readRowRaw(id: string): Promise<Record<string, unknown> | undefined> {
  ...
  // version to read the post-migration shape). Currently v18
  // (v16 = tool-input shape sweep, v17 = approval-mode mode/plan
  // fields, v18 = Conversation.source + mcpHostName backfill).
