// MIRROR of packages/mcp-server/src/ws/protocol.ts — keep in sync.
// (Both sides keep their own copy to avoid cross-package imports during
// MV3 service-worker build; the file is small and changes rarely.)
 ...
 * ~20s. The extension does not need to respond.
 */
